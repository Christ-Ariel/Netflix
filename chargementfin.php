...
// Définir la variable de session pour indiquer que l'utilisateur vient de la page de chargement
$_SESSION['from_loading'] = true;
?>
...
<head>
    ...
    <script>
        ...
        setTimeout(function(){
            window.location.href = 'identif.php?from=loading';
        }, 10000);
    </script>
</head>
<body>
